...
- ✅ `.specify/templates/*.md` - All template files (spec, plan, tasks,
  checklist, etc.)
- ✅ `.specify/scripts/` - All automation scripts (bash, etc.)

### Feature Documentation

- ✅ `specs/**/spec.md` - Feature specifications (hand-written or
  agent-generated)
...
2. **Team Collaboration**: Other team members see the complete implementation
   plan
...
1. **Regenerated**: Built dynamically from other tracked files (constitution,
   plans, templates)
...
4. **Single Source of Truth**: Constitution and plans are the source; context is
   derived
...
2. **After creating spec**: `git add specs/###-feature-name/spec.md
   specs/###-feature-name/checklists/`
3. **After generating plan**: `git add specs/###-feature-name/plan.md
...
- Merge feature branch after specification is approved and implementation
  complete
